...
if System.get_env("PHX_SERVER") && System.get_env("RELEASE_NAME") do
  config :ra_backend, RaBackendWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :ra_backend, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :ra_backend, RaBackend.Mailer,
  ...
  # LLM provider configurations for production
